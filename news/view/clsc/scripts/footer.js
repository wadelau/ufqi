...
function openLocalWin(myUrl, myTitle){
	if(true && typeof api != 'undefined'){
		...
		//console.log("clsc open by click.....myUrl:"+myUrl);
	}
...
if(true){
	...
	if(selfkw){
		...
		//console.log("read clientStorage.clsc:"+$val);
...
function addBookMark() {
	var xtitle = "UfqiNews";
	var xurl = "https://ufqi.com/news/?mod=clsc&sid=bookmark";
	if(document.all) { // ie
...
if('{$mod}'!='intro' && '{$ref}'!='introiframe'){
	if(window.addEventListener){
		...
		//console.log("resize attached. clsc");
	}
	else{
		resizeWindow();	
